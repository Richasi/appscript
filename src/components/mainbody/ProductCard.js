...
const ProductCard = ({ prod }) => {
    ...
    return (
        <div className="mx-auto mt-11 w-32 md:w-40 xl:w-56 transform overflow-hidden shadow-md duration-300 hover:scale-105 cursor-pointer">
            {/* Container with fixed size */}
            <div className="relative w-full h-32 md:h-40 xl:h-56">
                <img
