    ...
    return (
        <div className="w-full max-w-[95rem] mx-auto">
            <div className="my-8 p-4 md:px-10 flex justify-between items-center uppercase border-t-[1px] border-b-[1px] border-slate-400">
                <span onClick={() => setShowFilter(!showFilter)} className="w-full sm:w-1/2 text-center md:hidden cursor-pointer font-bold  ">Filter</span>
                <span onClick={() => setShowFilter(!showFilter)} className="hidden font-bold  md:block cursor-pointer">Show Filter</span>
                <span className="w-[2px] h-[26px] bg-black md:hidden"></span>
                <select className="  font-bold  uppercase text-center cursor-pointer">
                ...
                {showFilter && (
                    <div className="relative md:static z-20 bg-white w-[150px] pl-3 md:w-[260px]">
                        <div className="flex gap-3">
                            ...
                            <label className=" font-bold uppercase">Customizable</label>
                        </div>
